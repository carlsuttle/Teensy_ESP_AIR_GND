...
class BMI2_BMM1_Class {
  public:
    ...
    int readAccelerationRaw(int16_t& x, int16_t& y, int16_t& z);
    int readGyroscopeRaw(int16_t& x, int16_t& y, int16_t& z);
    ...
    bool getAccelConfig(uint8_t& odr, uint8_t& range, uint8_t& bwp, uint8_t& filterPerf);
    bool getGyroConfig(uint8_t& odr, uint8_t& range, uint8_t& bwp, uint8_t& noisePerf, uint8_t& filterPerf);
    bool setAccelConfig(uint8_t odr, uint8_t range, uint8_t bwp, uint8_t filterPerf);
    bool setGyroConfig(uint8_t odr, uint8_t range, uint8_t bwp, uint8_t noisePerf, uint8_t filterPerf);
  ...
  private:
    ...
    float _acc_lsb_per_g = 8192.0f;
    float _gyr_lsb_per_dps = 65.536f;
    Stream * _debug = NULL;
};
